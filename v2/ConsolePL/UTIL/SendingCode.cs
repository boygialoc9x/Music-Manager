...
namespace ConsolePL.UTIL
{
    public class SendingCode
    {
        ...
        public static void SendPremiumGmail(Customer cus)
        {
            string to = cus.gmail;

            string subject = "E-mail Authentication Notice";
            string message = $"Hi, {cus.firstName} {cus.lastName}!. If you want us to upgrade you to Premium member, contact us at (email here) with any questions or concerns.";
